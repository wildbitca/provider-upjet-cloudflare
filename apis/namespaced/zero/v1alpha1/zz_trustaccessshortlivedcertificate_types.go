...
// TrustAccessShortLivedCertificate is the Schema for the TrustAccessShortLivedCertificates API. Accepted Permissions Access: Apps and Policies ReadAccess: Apps and Policies Write
