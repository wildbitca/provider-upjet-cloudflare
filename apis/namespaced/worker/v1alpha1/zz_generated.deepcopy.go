...
func (in *ExportsInitParameters) DeepCopyInto(out *ExportsInitParameters) {
	*out = *in
	...
	if in.RenamedTo != nil {
		in, out := &in.RenamedTo, &out.RenamedTo
		*out = new(string)
		**out = **in
	}
	if in.State != nil {
	...
	if in.TransferFrom != nil {
		in, out := &in.TransferFrom, &out.TransferFrom
		*out = new(string)
		**out = **in
	}
	if in.TransferredTo != nil {
		in, out := &in.TransferredTo, &out.TransferredTo
		*out = new(string)
		**out = **in
	}
	if in.Type != nil {
