...
// ZoneTransfersIncoming is the Schema for the ZoneTransfersIncomings API. Accepted Permissions DNS ReadDNS WriteZone Settings ReadZone Settings WriteZone Write
