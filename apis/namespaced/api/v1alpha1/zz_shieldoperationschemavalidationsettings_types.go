...
// ShieldOperationSchemaValidationSettings is the Schema for the ShieldOperationSchemaValidationSettingss API. Accepted Permissions Account API GatewayAccount API Gateway ReadDomain API GatewayDomain API Gateway Read
