...
import (
	...
	clusterv1beta1 "github.com/wildbitca/provider-upjet-cloudflare/apis/cluster/v1beta1"
	namespacedv1beta1 "github.com/wildbitca/provider-upjet-cloudflare/apis/namespaced/v1beta1"
)
...
const (
	...
	// Cloudflare provider config keys (https://registry.terraform.io/providers/cloudflare/cloudflare/latest/docs)
	keyAccountID         = "account_id"
	keyAPIBasePath       = "api_base_path"
	keyAPIClientLogging  = "api_client_logging"
	keyAPIHostname       = "api_hostname"
	keyAPIKey            = "api_key"
...
// credentialKeys is the list of Cloudflare provider config keys to copy from credentials.
var credentialKeys = []string{
	keyAccountID, keyAPIBasePath, keyAPIClientLogging, keyAPIHostname,
	keyAPIKey, keyAPIToken, keyAPIUserServiceKey, keyEmail,
}
